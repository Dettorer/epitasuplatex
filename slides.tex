...
\begin{frame}{Libreoffice, Word, etc. ou \LaTeX?}
    \begin{description}
        ...
        \item[Mathématiques:] personne n'égale \TeX, même les articles wikipedia
            l'utilisent.
        \item[Compilation vs édition:] \LaTeX{} est un \emph{compilateur}
        ...
        \item[WYSIWYG\footnote{What You See Is What You Get}:] pas un vrai
            ...
            des éditeurs \LaTeX{} WYSIWYG).
        \item[Courbe d'apprentissage:] apprendre à utiliser correctement \LaTeX
            est long et souvent frustrant.
    \end{description}
\end{frame}
...
\begin{frame}{Autres paquets et classes intéressantes}
    \begin{description}
...
\begin{frame}{Les sources de ces slides}
    ...
    \centering \url{https://github.com/Dettorer/epitasuplatex}
\end{frame}
