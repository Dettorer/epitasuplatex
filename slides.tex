    ...
    \begin{columns}
        ...
        \begin{column}{0.43\textwidth}
            \begin{tcolorbox}[title=exemple.pdf, overlay=]
                \input{examples/basics-syntax.tex}
            \end{tcolorbox}
        \end{column}
    \end{columns}
...
\begin{frame}[fragile]{Les classes de document}
    ...
    \begin{description}
        \item[Lettre :] \texinline{\documentclass[a4paper]{letter}}\\
            ...
            etc…
        \item[Article :] \texinline{\documentclass{article}} \vspace{-4pt}
        \item[Rapport :] \texinline{\documentclass{report}} \vspace{-4pt}
...
\begin{frame}[fragile]{Quelques élément typographiques}
    \begin{columns}
        ...
        \begin{column}{0.50\textwidth}
            \begin{tcolorbox}[title=exemple.pdf, overlay=]
                \input{examples/typo-examples.tex}
            \end{tcolorbox}
        \end{column}
    \end{columns}
\end{frame}
